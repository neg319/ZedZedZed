...
namespace CustomizableZombieHorde
{
    public static class ZombieRulesUtility
    {
        ...
        public static bool IsZombieAlignedCritter(Pawn pawn)
        {
            ...
            return string.Equals(kindDefName, "CZH_CrawlerKind", StringComparison.Ordinal)
                || string.Equals(kindDefName, "CZH_GraveRuntKind", StringComparison.Ordinal)
                || string.Equals(kindDefName, "CZH_RuntKind", StringComparison.Ordinal)
                || string.Equals(thingDefName, "CZH_Crawler", StringComparison.Ordinal)
